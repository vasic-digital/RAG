# RAG - A generic, reusable Go module providing core RAG (Retrieval-Augmented Generation) primitives for building retrieval-augmented applications.
# Module: digital.vasic.rag
...
challenge:
	../challenges/scripts/rag_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "RAG - A generic, reusable Go module providing core RAG (Retrieval-Augmented Generation) primitives for building retrieval-augmented applications."
	@echo ""
	@echo "Build & Test:"
