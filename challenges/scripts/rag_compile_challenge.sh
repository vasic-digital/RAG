#!/usr/bin/env bash
# rag_compile_challenge.sh - Validates RAG module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.rag"
if grep -q "^module digital.vasic.rag$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.rag"
else
